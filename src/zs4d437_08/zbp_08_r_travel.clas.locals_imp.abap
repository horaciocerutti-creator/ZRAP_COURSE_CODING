    ...
    METHODS:
      get_instance_authorizations FOR INSTANCE AUTHORIZATION
        IMPORTING
          keys
            REQUEST
            requested_authorizations FOR Travel
        RESULT
          result,
...
CLASS lhc_Travel IMPLEMENTATION.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      ELSE.
        ...
        APPEND VALUE #( %tky = <travel>-%tky
                        %msg = NEW zcm_08_travel( textid = zcm_08_travel=>already_canceled ) ) TO reported-travel.
      ENDIF.
  ...
  METHOD validateDescription.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      IF <travel>-Description IS INITIAL.
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky                 = <travel>-%tky
                        %msg                 = NEW zcm_08_travel( textid = /lrn/cm_s4d437=>field_empty )
  ...
  METHOD validateDateSequence.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      IF <travel>-BeginDate GT <travel>-EndDate.
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky               = <travel>-%tky
                        %msg               = NEW zcm_08_travel( textid = /lrn/cm_s4d437=>dates_wrong_sequence )
                        %element-begindate = if_abap_behv=>mk-on ) TO reported-travel.
      ELSEIF <travel>-BeginDate LT cl_abap_context_info=>get_system_date( ).
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky               = <travel>-%tky
                        %msg               = NEW zcm_08_travel( textid = /lrn/cm_s4d437=>begin_date_past )
                        %element-begindate = if_abap_behv=>mk-on ) TO reported-travel.
      ELSEIF <travel>-BeginDate IS INITIAL.
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky               = <travel>-%tky
                        %msg               = NEW zcm_08_travel( textid = /lrn/cm_s4d437=>field_empty )
                        %element-BeginDate = if_abap_behv=>mk-on ) TO reported-travel.
      ELSEIF <travel>-EndDate IS INITIAL.
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky             = <travel>-%tky
                        %msg             = NEW zcm_08_travel( textid = /lrn/cm_s4d437=>field_empty )
  ...
  METHOD earlynumbering_create.
    ...
    mapped-travel = VALUE #( FOR <entity> IN entities
                             ( %cid      = <entity>-%cid
                               ...
                               agencyid  = /lrn/cl_s4d437_model=>get_agency_by_user( )
  ...
  METHOD get_instance_features.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      IF <travel>-%is_draft EQ if_abap_behv=>mk-on.
      ...
      IF    <travel>-Status EQ 'C'
         OR (     <travel>-EndDate IS NOT INITIAL
              AND <travel>-EndDate LT cl_abap_context_info=>get_system_date( ) ).
      ...
      IF <travel>-BeginDate IS NOT INITIAL AND <travel>-BeginDate LT cl_abap_context_info=>get_system_date( ).
